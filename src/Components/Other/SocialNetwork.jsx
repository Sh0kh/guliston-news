    ...
    return (
        <div className="SocialMedia fixed bg-[white] shadow-2xl border-[2px] border-MainColor p-[10px] rounded-r-[10px] left-0 top-[50%] z-40">
            <div className="flex items-center flex-col gap-[15px]">
                <a className="text-[30px] hover:scale-110 transition-transform duration-300" href="https://www.facebook.com/Sirdaryohokimligi" target="_blank" rel="noopener noreferrer">
                ...
                <a className="text-[30px] hover:scale-110 transition-transform duration-300" href="https://www.instagram.com/sirdaryohokimligi/" target="_blank" rel="noopener noreferrer">
                ...
                <a className="text-[30px] hover:scale-110 transition-transform duration-300" href="https://t.me/SirdaryoUz" target="_blank" rel="noopener noreferrer">
                ...
                <a className="text-[25px] hover:scale-110 transition-transform duration-300" href="https://www.youtube.com/channel/UCrjORuJqc-pPPjl3zvRxZMw" target="_blank" rel="noopener noreferrer">
