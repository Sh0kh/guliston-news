...
export default function SocialNetwork() {
    ...
    return (
        <div className="SocialMedia fixed bg-[white] shadow-2xl border-[2px] border-MainColor p-[10px] rounded-r-[10px] left-0 top-[50%] z-40">
            <div className="flex items-center flex-col gap-[15px]">
                <a className="text-[30px] hover:scale-110 transition-transform duration-300" href="https://www.facebook.com/Guliston0336/" target="_blank" rel="noopener noreferrer">
                ...
                <a className="text-[30px] hover:scale-110 transition-transform duration-300" href="https://www.instagram.com/gulistonshahar_hokimligi/" target="_blank" rel="noopener noreferrer">
                ...
                <a className="text-[30px] hover:scale-110 transition-transform duration-300" href="https://t.me/GulistanUz" target="_blank" rel="noopener noreferrer">
                ...
                <a className="text-[25px] hover:scale-110 transition-transform duration-300" href="https://www.youtube.com/channel/UCMIkh90sFxZdiZTqwBgzzaA" target="_blank" rel="noopener noreferrer">
