...
export default function OpenDataCreate({ isOpen, onClose, refresh }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            await axios.post(`/file/data/create`, formData, {
                headers: {
        ...
        <NormalModal isOpen={isOpen} onClose={onClose}>
            <div className="p-[20px] overflow-y-auto">
                <div className="flex items-center justify-between">
                    <h1 className="text-[25px] font-bold">Ma'lumot yaratish</h1>
