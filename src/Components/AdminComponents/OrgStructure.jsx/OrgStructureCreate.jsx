...
export default function OrgStructureCreate({ isOpen, onClose, refresh }) {
    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            formData.append("category", ' TASHKILIY_TUZILMA');
            formData.append("context", content);


            await axios.post(`/organization/create`, formData, {
                headers: {
        ...
        <BigModal isOpen={isOpen} onClose={onClose}>
            <div className="p-[20px]">
                <div className="flex items-center justify-between">
                    <h1 className="text-[25px] font-bold">Tashkiliy tuzilmasi yaratish</h1>
