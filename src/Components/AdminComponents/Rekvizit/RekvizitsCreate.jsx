...
export default function RekvizitsCreate({ isOpen, onClose, refresh }) {
    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            formData.append("category", ' REKVIZITLAR');
        ...
        <BigModal isOpen={isOpen} onClose={onClose}>
            <div className="p-[20px]">
                <div className="flex items-center justify-between">
                    <h1 className="text-[25px] font-bold">Rekvizit yaratish</h1>
